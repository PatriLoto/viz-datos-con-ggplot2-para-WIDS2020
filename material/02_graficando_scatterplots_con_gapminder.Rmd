...
```{r graficos_plotly,message=FALSE, warning=FALSE, fig.height=6, fig.width=8, fig.show="hold"}
...
ggplotly(pTheme_final, tooltip = "text") 

```


```{r graficos_plotly_2, message=FALSE, warning=FALSE, fig.show="hold", fig.height=8, fig.width=12 }
library(plotly)
ggplotly(p_facet)
