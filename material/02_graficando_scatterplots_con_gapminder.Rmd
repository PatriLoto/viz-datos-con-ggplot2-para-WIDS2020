...
- Con `legend.text= element_text(color="#2c204d", size= text_size)` especificamos el color y el tamaño 
del texto de la leyenda.
...
```{r para_plotly, message=FALSE, warning=FALSE,include=FALSE, fig.height=6, fig.show="hold", fig.width=8}
...
```{r graficos_plotly,fig.show="hold", fig.height=6,fig.width=8, message=FALSE, warning=FALSE}
