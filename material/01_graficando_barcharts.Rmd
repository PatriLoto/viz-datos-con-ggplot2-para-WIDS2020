...
# 1.2 gráfico de barras contiguas con position= "dodge"
ggplot(data=subset_propina,aes(x=time, y=total_bill, fill=sex))+
...
```{r position_fill, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=6, fig.width=8}
ggplot(data=subset_propina, aes(x=time, y=total_bill, fill=sex))+
...
```{r coord_escalas_4, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=6, fig.width=8}
ggplot(data=subset_propina, aes(x=time, y=total_bill, fill=sex))+
...
```{r etiquetas_x_y, message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', fig.height=6, fig.width=8}
ggplot(data=subset_propina, aes(x= time, y= total_bill, fill= sex))+
       geom_bar(stat = "identity", position= position_dodge(), width=.7, color= "black")+
       scale_x_discrete(limit=c("Lunch","Dinner"), labels=c("Almuerzo", "Cena"))+
       scale_y_continuous(labels = scales::dollar)+
...
```{r color,  message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', fig.height=6, fig.width=8}
...
```{r theme_classic,  message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', fig.height=6, fig.width=8}
ggplot(data=subset_propina, aes(x=time, y=total_bill, fill=sex))+
...
```{r theme_bw,  message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', fig.height=8, fig.width=6, tidy=TRUE}
...
```{r grafico_png,  message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', fig.height=8, fig.width=6, highlight=TRUE, tidy=TRUE}
...
```{r grafico_ggtext ,  message=FALSE, warning=FALSE, echo=TRUE, fig.align='center', fig.height=8, fig.width=6, highlight=TRUE, tidy=TRUE}
